...
const RecursiveScan = (
  ...
  if (subData.haveChildren === true) {
    ...
    columnsList.includes(subData.headerName)
      ? null
      : columnsList.push(subData.headerName);
    function onClick() {
    ...
    selectedCellHeaderStyle && selectedPosition.idx === subData.idx
      ...
      : style;
console.log("selectedPosition.idx",selectedPosition?.idx,subData);
    return (
      <div
        role="columnheader"
        aria-colindex={`${column.index + 1}.${
          columnsList.indexOf(subData.headerName) + 1
        }`}
